...
from paprika.utils.utils import get_data_filename

DEFAULT_PINT_REGISTRY = pint.UnitRegistry(
...
def _unpickle_quantity(cls, *args):
    ...
    return pint._unpickle(DEFAULT_PINT_REGISTRY.Quantity, *args)


def _unpickle_unit(cls, *args):
    """Rebuild unit upon unpickling using the application registry."""
    return pint._unpickle(DEFAULT_PINT_REGISTRY.Unit, *args)


def _unpickle_measurement(cls, *args):
    """Rebuild measurement upon unpickling using the application registry."""
    return pint._unpickle(DEFAULT_PINT_REGISTRY.Measurement, *args)


class Unit(_Unit):
    _REGISTRY = DEFAULT_PINT_REGISTRY
...
DEFAULT_PINT_REGISTRY.Unit = Unit
DEFAULT_PINT_REGISTRY.Quantity = Quantity
DEFAULT_PINT_REGISTRY.Measurement = Measurement

pint.set_application_registry(DEFAULT_PINT_REGISTRY)
DEFAULT_PINT_REGISTRY.default_format = "~"
